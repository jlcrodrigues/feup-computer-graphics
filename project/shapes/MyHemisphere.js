...
export class MyHemisphere extends CGFobject {
    ...
    initMaterials() {
        this.hemisphereMaterial = new CGFappearance(this.scene);
        this.hemisphereMaterial.setAmbient(1, 1, 1, 1.0)
    }
    ...
    initBuffers() {
        ...
        for (let i = 0; i < (this.stacks + 1)/2; i++) {
    ...
    setTexture(texture) {
        this.hemisphereMaterial = new CGFappearance(this.scene);
        this.hemisphereMaterial.setTexture(texture);
