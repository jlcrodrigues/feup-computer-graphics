...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.unitCubeQuad = new MyUnitCubeQuad(this,"images/mineTop.png","images/mineSide.png",
                                    "images/mineSide.png","images/mineSide.png",
    ...
    initCameras() {
        this.camera = new CGFcamera(0.4, 0.1, 500, vec3.fromValues(15, 15, 75), vec3.fromValues(0, 0, 0));
    }
